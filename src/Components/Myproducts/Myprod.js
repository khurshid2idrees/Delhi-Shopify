        ...
        <div class="container px-6 py-8 mx-auto">
            <div class="lg:flex lg:-mx-2">
                <div class="space-y-3 lg:w-1/5 lg:px-2 lg:space-y-4">
                    ...
                    <a href="#" class="block font-medium text-gray-500 dark:text-gray-300 hover:underline">Kid's Shirt</a>
                    <a href="#" class="block font-medium text-blue-600 dark:text-blue-500 hover:underline">Men's Night Suit</a>
                    <a href="#" class="block font-medium text-blue-600 dark:text-blue-500 hover:underline">Women's Night Suit</a>
                    <a href="#" class="block font-medium text-gray-500 dark:text-gray-300 hover:underline">Kid's Night Suit</a>
                    <a href="#" class="block font-medium text-gray-500 dark:text-gray-300 hover:underline">Ladies Top</a>
                    <a href="#" class="block font-medium text-gray-500 dark:text-gray-300 hover:underline">Ladies Kurti</a>
